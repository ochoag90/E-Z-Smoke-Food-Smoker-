...
float Thermistor(int RawADC) {
  ...
  Temp = 1 / (0.0011068369 + (0.0002384641754 * Temp) + (0.00000006507394466 * Temp * Temp * Temp));
...
Serial.print("#S|LOGTEST|[");
  ...
  float temp2;
  temp2=Thermistor(analogRead(ThermistorPIN1));       // read ADC and  convert it to Celsius
  Serial.print("#S|LOGTEST1|[");
  ...
  float temp3;
  temp3=Thermistor(analogRead(ThermistorPIN2));       // read ADC and  convert it to Celsius
  Serial.print("#S|LOGTEST2|[");
  Serial.print(temp3,1);
  Serial.println("]#");  
  Serial.print("Celsius: "); 
  Serial.print(temp3,1);                             // display Celsius
  //temp = (temp * 9.0)/ 5.0 + 32.0;                  // converts to  Fahrenheit
  //Serial.print(", Fahrenheit: "); 
  //Serial.print(temp,1);                             // display  Fahrenheit
  Serial.println("temp");    
